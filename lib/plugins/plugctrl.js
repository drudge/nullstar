...
PluginControlPlugin.prototype.$load = function(nick, chan, name) {
  ...
  this.bot.error(chan, format("%s plugin failed to load", name));
...
PluginControlPlugin.prototype.$unload = function(nick, chan, name) {
  ...
  this.error(chan, format("%s plugin failed to unload", name));
...
PluginControlPlugin.prototype.$reload = function(nick, chan, name) {
  ...
  this.error(chan, format("%s plugin failed to reload", name));
...
PluginControlPlugin.prototype.error = function(channel, error, code) {
