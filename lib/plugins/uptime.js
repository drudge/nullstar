...
UptimePlugin.prototype.$uptime = function(id, nick, chan) {
  var uptime = [];
  ...
  this.bot.notice(id, chan, format('Uptime: %s', uptime));
...
UptimePlugin.prototype.$downtime = function(id, nick, chan) {
  this.bot.say(id, chan, format('%s: Your mom.', nick));
};
...
UptimePlugin.prototype.$peanutbutterjellytime = function(id, nick, chan) {
  this.bot.say(id, chan, format('%s: http://www.youtube.com/watch?v=s8MDNFaGfT4', nick));
};
