...
WeatherPlugin.prototype.$weather = function(id, nick, chan, location) {
  ...
  weather.forecast(location, {cc:'yes', includeLocation: 'yes'}, function(err, json) {
    ...
    if (!json.current_condition || !json.current_condition.length) {
      this.bot.notice(id, chan, 'Please input a proper location or zip code (US or Canada). ' +
